...
// express.js middleware to instruct the server to make certain files (the public folder) readily available and not to gate it behind a server endpoint (allows css to come through)
app.use(express.static('public'));

// parse incoming string or array data so it can be accessed by req.body object. extended: true option inside method informs server that there may be sub-array data nested so look deeper into POST
...
// add / route to get to root of folder. and respond with and html page which will displayed in browser
app.get('/', (req, res) => {
